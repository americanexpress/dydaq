...
import com.americanexpress.dydaq.graphql.ddq.dynamicquery.demoproj.dto.base.HospitalCountBase;
 ...
 * <p>
 * This entity will be used by GraphQL client for aggregation purpose by adding
 * aggregate functions in the Query Builder
 */
@RootEntity
@Table(name = "hospital_tbl")
public class HospitalCount extends HospitalCountBase {
}
