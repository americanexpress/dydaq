...
/**
 * @EnableDynamicQuery annotation needs to be added in the Spring boot main class to
 * enable support for dynamic query.
 */
@Target(ElementType.TYPE)
@Retention(RetentionPolicy.RUNTIME)
@Import({DynamicQueryGenerator.class, SimpleGraphObject.class})
public @interface EnableDynamicQuery {
}